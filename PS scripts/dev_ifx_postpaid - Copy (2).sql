...
informix.tfif|factuur_opboeking|Lookup([informix.debtrans],[datum],[fact_nr],[fact_nr])
informix.tfif|factuur_jaar|Lookup([informix.debtrans],[factuur_jaar],[fact_nr],[fact_nr])
...
informix.tfnf|factuur_opboeking|Lookup([informix.debtrans],[datum],[fact_nr],[fact_nr])
informix.tfnf|factuur_jaar|Lookup([informix.debtrans],[factuur_jaar],[fact_nr],[fact_nr])
...
informix.tfof|factuur_opboeking|Lookup([informix.debtrans],[datum],[fact_nr],[fact_nr])
informix.tfof|factuur_jaar|Lookup([informix.debtrans],[factuur_jaar],[fact_nr],[fact_nr])
...
informix.beschfac|reke_naam|Lookup([informix.rekening],[naam],[reke_nr],[reke_nr])
informix.incicode|reke_naam|Lookup([informix.rekening],[naam],[reke_nr],[reke_nr])
...
informix.kvetarf|reke_naam|Lookup([informix.rekening],[naam],[reke_nr],[reke_nr])
informix.debtrans|factuur_jaar|GetYear(AddMonths(datum,-1))
